              ...
              <div className="lg:w-1/2 p-8 lg:p-12">
                <div className="max-w-sm mx-auto">
                  <div className="text-center mb-8">
                    <div className="inline-flex items-center bg-orange-100 text-orange-600 px-3 py-1 rounded-full text-sm font-medium mb-4">
                      👋 welcome to ExamPro
                    </div>
              ...
              <div className="lg:w-1/2 bg-gradient-to-br from-purple-600 via-purple-500 to-pink-500 p-8 lg:p-12 flex items-center justify-center text-white relative overflow-hidden">
                <div className="text-center relative z-10">
                  ...
                  <p className="text-xl mb-6 text-blue-100">
                    Already have an account? <Link to="/login" className="text-yellow-300 hover:text-yellow-200 underline font-semibold">Sign in!</Link>
                  </p>
